		...
		internal class Examples
			{
				...
				/*
					static double Cube(double numberParameter)
						{
							Math.Pow(numberParameter, 3);
						}
				*/
				...
				*/
				...
				/*
					static void PassReference(ref int numberParameter)
						{
							numberParameter = 101;
						}
				*/
				...
				/*
					static void PassReference(ref int number1Parameter, ref int number2Parameter)
						{
				...
				*/
				...
				/*
					static void DoubleIt(int numberParameter, out int resultParameter)
						{
				...
				*/
				...
				static void Example22()  // Generic class
					{
						...
						Employee<string, int> types = new Employee<string, int>(name, age);
				...
				static void DisplayName(Department x)
					{
						x = new Department();
						x.ToString();

						Console.WriteLine(x.DepartmentName);
					}
			}
	}