...
namespace WGU_C968
	{
		partial class ModifyPart
			...
			this.outsourcedRadBtn.TabIndex = 54;
			...
			this.inhouseRadBtn.TabIndex = 53;
			...
			this.companyNameLbl.TabIndex = 51;
			...
			// companyNameTxt
			// 
			this.companyNameTxt.BackColor = System.Drawing.Color.PaleGreen;
			...
			this.companyNameTxt.TabIndex = 44;
			this.companyNameTip.SetToolTip(this.companyNameTxt, "Machine ID require number");
