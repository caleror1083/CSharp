...
namespace WGU_C968
	{
		partial class ModifyProduct
			...
			this.associatedPartsGrpBox.TabIndex = 51;
			...
			this.allPartsGrpBox.Controls.Add(this.searchProductTxt);
			this.allPartsGrpBox.Controls.Add(this.searchProductBtn);
			...
			this.allPartsGrpBox.TabIndex = 50;
			...
			// searchProductTxt
			// 
			this.searchProductTxt.Location = new System.Drawing.Point(282, 19);
			...
			// searchProductBtn
			// 
			this.searchProductBtn.Location = new System.Drawing.Point(201, 16);
			...
			// minTxt
			// 
			this.minTxt.BackColor = System.Drawing.Color.PaleGreen;
			...
			this.minTxt.TabIndex = 57;
			this.minTxt.TextChanged += new System.EventHandler(this.minTxt_TextChanged);
			// 
			// maxTxt
			// 
			this.maxTxt.BackColor = System.Drawing.Color.PaleGreen;
			...
			// priceTxt
			// 
			this.priceTxt.BackColor = System.Drawing.Color.PaleGreen;
			...
			// inventoryTxt
			// 
			this.inventoryTxt.BackColor = System.Drawing.Color.PaleGreen;
			...
			this.titleLbl.Size = new System.Drawing.Size(78, 13);
			this.titleLbl.TabIndex = 52;
			this.titleLbl.Text = "Modify Product";
			// 
			// ModifyProduct
			// 
