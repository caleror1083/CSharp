    ...
    <body>
        <form id="MainForm" runat="server">
            <table style="font-family:Arial; border:1px solid black; text-align:center">
                ...
                <tr>
                    <td><asp:TextBox ID="Counter1Textbox" runat="server" BackColor="Blue" Font-Size="Large" Width="150px" ForeColor="White"></asp:TextBox></td>
                    <td></td>
                ...
                <tr>
                    <td><asp:Button ID="Counter1Button" runat="server" Text="Next" Width="150px" OnClick="Counter1Button_Click" /></td>
                    <td></td>
                    <td><asp:Button ID="Counter2Button" runat="server" Text="Next" Width="150px" OnClick="Counter2Button_Click" /></td>
                    <td></td>
                    <td><asp:Button ID="Counter3Button" runat="server" Text="Next" Width="150px" OnClick="Counter3Button_Click" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="5"><asp:ListBox ID="TokensList" runat="server" Font-Size="Large" Width="100px"></asp:ListBox></td>
                </tr>
                <tr>
