				...
				static void Example1()
					{
						...
						SqlConnection myConnection = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=Company;Integrated Security=True");    // Creates an instance of the database connection
